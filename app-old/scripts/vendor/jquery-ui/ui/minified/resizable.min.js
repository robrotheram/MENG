...
(function (t) {
  ...
  return t.widget("ui.resizable", t.ui.mouse, {
    ...
    start: function () {
      var e, i, s, o, n, r, a, h = t(this).resizable("instance"), l = h.options, p = h.element, c = l.containment, d = c instanceof t ? c.get(0) : /parent/.test(c) ? p.parent().get(0) : c;
      ...
      }, s = h.containerOffset, o = h.containerSize.height, n = h.containerSize.width, r = h._hasScroll(d, "left") ? d.scrollWidth : n, a = h._hasScroll(d) ? d.scrollHeight : o, h.parentData = {
        element: d,
        left: s.left,
        top: s.top,
        width: r,
      ...
      var i, s, o, n, r = t(this).resizable("instance"), a = r.options, h = r.containerOffset, l = r.position, p = r._aspectRatio || e.shiftKey, c = {
        top: 0,
        left: 0
      }, d = r.containerElement, u = !0;
