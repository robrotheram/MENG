...
THREE.WebGLDeferredRenderer = function (parameters) {
  ...
  this.addEffect = function (effect, normalDepthUniform, colorUniform) {
    ...
    if (effect.material && effect.uniforms) {
      ...
      if (normalDepthUniform || colorUniform) {
        ...
        resizableMaterials.push({
          "material": effect.material,
          "normalDepth": normalDepthUniform,
          "color": colorUniform
        });
  ...
  var createRenderTargets = function () {
    ...
    switch (tonemapping) {
      ...
      case THREE.SimpleOperator:
        defines = {"TONEMAP_SIMPLE": true};
        break;
      case THREE.LinearOperator:
        defines = {"TONEMAP_LINEAR": true};
        break;
      case THREE.ReinhardOperator:
        defines = {"TONEMAP_REINHARD": true};
        break;
      case THREE.FilmicOperator:
        defines = {"TONEMAP_FILMIC": true};
        break;
      case THREE.UnchartedOperator:
        defines = {"TONEMAP_UNCHARTED": true};
        break;
